...
public class ExaltationPickaxeItem extends PickaxeItem {
    public ExaltationPickaxeItem() {
        super(ItemTier.NETHERITE, 2, -2.8f,
    ...
    @Override public boolean hurtEnemy(ItemStack stack, LivingEntity attacked, LivingEntity attacker) {
        if(stack.getTag() != null) {
            ...
            if (ex != null) {
                ...
                ex.onAttack(attacker, attacked, 2, stack.getTag());
            }
            //}
        }
